========================================================================
    アプリケーション: FullScreen_CSharp プロジェクトの概要
========================================================================

この FullScreen_CSharp アプリケーションは、AppWizard により作成されました。  

このファイルには、FullScreen_CSharp 
アプリケーションを構成する各ファイルの内容の概要が含まれています。

FullScreen_CSharp.vcxproj
...
FullScreen_CSharp.vcxproj.filters
...
StdAfx.h、StdAfx.cpp
    これらのファイルは、FullScreen_CSharp.pch 
